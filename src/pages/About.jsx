...
import { CheckCircle, Laptop, BadgePercent, ShieldCheck, Headset, Flag, Eye } from 'lucide-react';

const fadeLeft = {
  initial: { opacity: 0, x: -60 },
  whileInView: { opacity: 1, x: 0 },
  transition: { duration: 1 }, // updated to 1 second
  ...
  return (
    <div className="bg-blue-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-16">
        {/* Page Title */}
        <motion.h1 {...fadeLeft} className="text-4xl sm:text-5xl font-extrabold text-gray-900 text-center bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text">
          About Dass Computer Stores
        </motion.h1>

        {/* Mission & Vision Cards */}
        <section className="space-y-8">
          <h2 className="text-3xl font-semibold text-gray-800 text-center">Our Mission & Vision</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <motion.div {...fadeLeft} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <motion.div {...fadeRight} className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center gap-4 mb-4">
        ...
        <section className="space-y-8">
          <h2 className="text-3xl font-semibold text-gray-800 text-center">Why Choose Dass Computer Store?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
            {[
              ...
              <motion.div key={title} {...(i % 2 === 0 ? fadeLeft : fadeRight)} className="flex items-start gap-4 bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        {/* Thank You Note */}
        <motion.section {...fadeLeft} className="text-center space-y-4">
